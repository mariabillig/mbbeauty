...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maria Billig Beauty" },
      {
        name: "description",
        content:
          "Nanopigmentação de sobrancelhas e micropigmentação labial com Maria Billig.",
      },
      { name: "author", content: "Maria Billig" },
      { property: "og:site_name", content: "Maria Billig Beauty" },
